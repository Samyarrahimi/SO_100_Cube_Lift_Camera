...
def some_public_function(x: int):
    print("[SO_100_Cube_Lift_With_Camera] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[SO_100_Cube_Lift_With_Camera] startup")
    ...
    def on_shutdown(self):
        print("[SO_100_Cube_Lift_With_Camera] shutdown")